    ...
    <>
      ...
      <section className="coming-soon">
        <div className="coming-soon__content">
          ...
          <h2 className="coming-soon__title">Stay Tuned for More Updates</h2>

          <p className="coming-soon__description">
            Exciting events, activities, and new experiences are on the way.
            Keep checking back for the latest updates from Target One.
          </p>

          <div className="coming-soon__line"></div>

          <span className="coming-soon__message">
